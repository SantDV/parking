...
namespace Parking
{
    internal class Conexiones
    {
        ...
        public DataTable historial()
        {
            ...
            string consulta = "SELECT id, patente,horaIngreso, horaSalida, nombre, total, estado, vehiculo.vehiculo, usuarios.usuario from ingresoysalida, clientes, usuarios, patentes, vehiculo where clientes.idCliente = patentes.cliente and ingresoysalida.patente = patentes.idPatente and vehiculo.idVehiculo = ingresoysalida.vehiculo and ingresoUsuario = usuarios.idUsuario;";
        ...
        public DataTable BuscarEmpleado(string dato, int tipoDeBusqueda)
        {
            MySqlConnection conexionDB = Conexiones.conexion();
            DataTable datable = new DataTable();
            MySqlDataReader resultado;
            ...
            if (tipoDeBusqueda == 0)
            {
                consultaBusqueda = "select idEmpleado, nombre, apellido, documento, domicilio, telefono, mail, usuarios.usuario from empleados, usuarios where empleados.usuario = usuarios.idusuario and idEmpleado = '" + dato + "';";
            }
            else if(tipoDeBusqueda == 1)
            {
                consultaBusqueda = "select idEmpleado, nombre, apellido, documento, domicilio, telefono, mail, usuarios.usuario from empleados, usuarios where empleados.usuario = usuarios.idusuario and empleados.nombre = '" + dato + "';";
            }
            else if (tipoDeBusqueda == 2)
            {
                consultaBusqueda = "select idEmpleado, nombre, apellido, documento, domicilio, telefono, mail, usuarios.usuario from empleados, usuarios where empleados.usuario = usuarios.idusuario and empleados.apellido = '" + dato + "';";
            }
            else
            {
                consultaBusqueda = "select idEmpleado, nombre, apellido, documento, domicilio, telefono, mail, usuarios.usuario from empleados, usuarios where empleados.usuario = usuarios.idusuario and empleados.documento = '" + dato + "';";
            }
