...
namespace Parking
{
    public partial class principal : Form
    {
        ...
        {
            //objeto conexion, que nos permite enviar los datos correspondiente
            Conexiones conexiones = new Conexiones();

            // valor boleano que valida si el vehicyulo esta o no ya estacionado
            bool yaIngresado = false;

            //ciclo for que recorre un datagrid donde estan los autos estacionados y nos dice si esta o no en el estacionamiento.
            conexiones.actualizarPlanillaPrincipal();

            for (int i = 0; i < dgvEstado.Rows.Count; i++)
            {
            ...
            else //si el vehculo no esta ingresado se realiza el ingreso normalmente
            {
